...
--
-- Name: logtype; Type: TABLE; Schema: public; Owner: dcds; Tablespace: 
--
...
--
-- Name: dcdssystem; Type: TABLE; Schema: public; Tablespace: 
--

CREATE TABLE dcdssystem (
...
--
-- Name: logtype_pkey; Type: CONSTRAINT; Schema: public; Owner: dcds; Tablespace: 
--
...
--
-- Name: log_logtypeid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dcds
--
...
--
-- Name: operational_period_incident_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dcds
--
...
ALTER TABLE ONLY system_workspace
    ADD CONSTRAINT system_id_fkey FOREIGN KEY (systemid) REFERENCES dcdssystem(systemid);
...
--
-- Name: workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dcds
--
